    ...
    data() {
      return{
        homeSlide:[
          {
            slideId:"slide5",
            slideTitle:"WE ARE STRONGER TOGETHER!",
          },
          {
            slideId:"slide4",
            slideTitle:"ABK WAS THE MAIN SPONSOR OF KALDER’S QUALITY CONGRESS 2019 INVITING DR. NOURIEL ROUBINI AS MAIN EVENT SPEAKER."
          },
          {
            slideId:"slide3",
            slideTitle:"STRENGHT THAT IS FORMED WITH JOINED VENTURES & BUSINESS PARTNERSHIPS",
          },
          {
            slideId:"slide2",
...
<style lang="scss">
  #homeSlider{
    ...
    .swiper-slide{
      ...
      &.slide4{
        background:url("../assets/img/banner-6.jpg") no-repeat;
        h2{
          font-size:36px;
          line-height: 44px;
        }
